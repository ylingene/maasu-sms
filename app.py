...
def sms():
	...
	if message_body == "banquet":
		...
		message = "The GenAPA show is from 7-9pm Friday night. You can pick up reserved tickets or purchase them at the door outside of Mendelssohn Theater at the Michigan League (Address: 911 N University Ave, Ann Arbor, MI 48104) starting at 6:30pm. We suggest you get there by 6:30";
	elif message_body == "spring":
		message = "Spring Into Maasu goes from 8:30-10:00pm at East Hall Psych Atrium (Address: 530 Church St, Ann Arbor, MI 48109). There will be free food and activites after registration. Ask your Small Group Leader for more information.";
	else:
		message = """Here are the commands I accept: 
					\n'parking': parking information
					\n'friday': Friday night information
